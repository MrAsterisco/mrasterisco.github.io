...
export default function App({
  ...
  return (
    <div className="w-[160px] text-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow border-1 border-gray-300 dark:border-gray-700 hover:border-accent dark:hover:border-accent-dark transition-all">
      <Link
        href={linkURL}
        target='_blank'
        className="block"
